...
var issuer = jwtSettings["Issuer"] ?? "ByteTechPOS";
var audience = jwtSettings["Audience"] ?? "ByteTechPOSUsers";
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "ByteTech POS API v1");
